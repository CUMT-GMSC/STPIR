...
parser.add_argument('--dataset', default='yoochoose1_64', help='dataset name: /Tmall/diginetica/yoochoose1_64')
...
parser.add_argument('--w_ne', type=float, default=0.9, help='neighbor weight')
parser.add_argument('--gama', type=float, default=1.7, help='cos_sim')
...
random_seed = random.randint(0, 2024)

fix_random_sees_as(random_seed)
